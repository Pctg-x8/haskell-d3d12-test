...
setRoot :: Ptr IDCompositionTarget -> Ptr IDCompositionVisual2 -> IO (Either HRESULT ())
setRoot this visual = do
  hr <- getFunctionPtr _VTBL_INDEX_SET_ROOT this >>= \f -> dcall_setRoot f this visual
